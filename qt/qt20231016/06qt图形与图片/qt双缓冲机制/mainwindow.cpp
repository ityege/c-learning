    ...
    QMainWindow(parent)
{
    ...
    setCentralWidget(drawWidget);//新建的Drawwidget 对象作为主窗口的中央窗体
...
void MainWindow::createToolBar(){
    ...
    widthSpinBox =new QSpinBox; //创建线宽选择控件
...
void MainWindow::ShowColor()
{
    ...
    QColor color = QColorDialog::getColor(static_cast<int>(Qt::black),this);//使用标准颜色对话框 QColorDialog 获得一个颜色值
    if(color.isValid()){
        drawWidget->setColor(color);QPixmap p(20,20);
        p.fill(color);
