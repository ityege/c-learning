...
int main()
{
    ...
    pszGetF << "July 4, 2000";
    pszGetF.imbue(loc);
    basic_istream<char>::_Iter i = use_facet<time_get<char>>(loc).get_date(basic_istream<char>::_Iter(pszGetF.rdbuf()),
    ...
    pszGetF3 << "Tuesday";
    pszGetF3.imbue(loc);
    i = use_facet<time_get<char>>(loc).get_weekday(basic_istream<char>::_Iter(pszGetF3.rdbuf()),
                                                   basic_istream<char>::_Iter(0), pszGetF3, st, &t);
    if (st & ios_base::failbit)
