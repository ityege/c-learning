...
void Geometry::updateLabel(){
    ...
    QString ystr;//获得 y()函数的结果并显示
    yValueLabel->setText(ystr.setNum(y()));

    QString frameStr;//获得 frameGeometry()函数的结果并显示
    ...
    QString sizeStr;//获得 size()函数的结果并显示
