...
int main()
{
	...
	const char* str2 = "Hello, my name is John!";
	...
	locale loc3("english");
	const wchar_t* str3 = L"\x0392fhello everyone";
	char str4[16];
	bool r3 = (use_facet<ctype<wchar_t>>(loc3).narrow(str3, str3 + wcslen(str3), 'X', &str4[0]) != 0);
	str4[wcslen(str3)] = '\0';
	wcout << str3 << endl;
	cout << &str4[0] << endl;
	// scan_is and scan_not
	locale loc4("German_Germany");
	const char* str5 = "Hello, my name is John!";
	...
	cout << "First nonalpha character is \"" << *i << "\" at position: " << i - str5 << endl;
	// tolower
