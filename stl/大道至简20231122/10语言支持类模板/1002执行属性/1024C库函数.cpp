...
{
    // denorm_min ()
    cout << "The smallest nonzero denormalized value(float). "
         << "object is: " << numeric_limits<float>::denorm_min() << endl;
    cout << "The smallest nonzero denormalized value(float). "
         << "object is: " << numeric_limits<int>::denorm_min() << endl;
    cout << "The smallest nonzero denormalized value(float). "
         << "object is: " << numeric_limits<double>::denorm_min() << endl;
    // 舍入为零
    cout << "The smallest nonzero denormalized value(float). "
         << "object is: " << numeric_limits<float>::denorm_min() / 2 << endl;
    cout << "The smallest nonzero denormalized value(float). "
         << "object is: " << numeric_limits<int>::denorm_min() / 2 << endl;
    cout << "The smallest nonzero denormalized value(float). "
         << "object is: " << numeric_limits<double>::denorm_min() / 2
         << endl;
    // digits
    ...
    cout << "digits(_int64): " << numeric_limits<int64_t>::digits << endl;
    // epsilon
    ...
    // has_infinity
    cout << "Whether float objects have infinity: " << numeric_limits<float>::has_infinity
         << endl;
    ...
    //cout << "Whether conform to iec559 standards (float)(是否遵从 IEC559 标准 . ): " << umeric_limits<float>::is_iec559 << endl;
    cout << "Whether conform to iec559 standards (double)(是否遵从 IEC559 标准 . ): " << numeric_limits<float>::is_iec559 << endl;
    cout << "Whether conform to iec559 standards (int)(是否遵从 IEC559 标准 . ): " << numeric_limits<float>::is_iec559 << endl;
    cout << "Whether conform to iec559 standards (unsigned char)(是否遵从 IEC559 标准 . ): " << numeric_limits<float>::is_iec559 << endl;
    // is_integer
    ...
    // is_specialized
    cout << "Whether be an explicit "
         << "specialization in the class: " << numeric_limits<float>::is_specialized << endl;
    cout << "Whether be an explicit "
         << "specialization in the class: " << numeric_limits<float *>::is_specialized << endl;
    cout << "Whether be an explicit "
         << "specialization in the class: " << numeric_limits<int>::is_specialized << endl;
    cout << "Whether be an explicit "
         << "specialization in the class: " << numeric_limits<int *>::is_specialized << endl;
    // max
